...
time.sleep(3)
os.system("clear")
print("\033[32mFOR TRAINING PURPOSES ONLY")

time.sleep(3)
os.system("clear")
print("\033[37mDO NOT USE TO ATTACK OFFICIAL SITES")

time.sleep(3)
os.system("clear")
print("\033[38;5;220mIF USED TO HELP PALESTINE, READ BISMILLAH")
...
def handleStatusCodes(status_code):
	...
	print(f"\r\033[38;5;220m Request |\033[37m" +url+ "\033[38;5;220m| \033[32m" +str(payload)+ "")
	sys.stdout.write(f"\r[ %i ] >" % request_counter)
	print(f"\r\033[32m Request \033[37m|\033[91m" +url+ "\033[37m| \033[38;5;220m" +str(payload)+ "")
	sys.stdout.flush()
	if status_code == 429:
